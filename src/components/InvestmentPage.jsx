    ...
    <div className="min-h-screen bg-slate-900">
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-white mb-4">投资理财</h1>
          <p className="text-gray-400">选择适合您的投资方案，开启数字资产增值之旅</p>
        </div>
          ...
          {investmentPlans.map((plan, index) => (
            ...
            >
              ...
              <button className="w-full mt-6 bg-blue-500 hover:bg-blue-600 text-white py-2 rounded-lg flex items-center justify-center">
                立即投资 <ArrowRight className="ml-2 w-4 h-4" />
              </button>
            </div>
          ))}
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-6">
          <div className="bg-slate-800 p-6 rounded-xl">
            ...
            <h3 className="text-xl font-bold text-white mb-2">资金安全</h3>
            <p className="text-gray-400">多重安全保障机制，资金由第三方托管，智能合约自动执行</p>
          </div>
          <div className="bg-slate-800 p-6 rounded-xl">
            <Wallet className="w-12 h-12 text-blue-400 mb-4" />
            <h3 className="text-xl font-bold text-white mb-2">灵活存取</h3>
            <p className="text-gray-400">7*24小时自由存取，到期自动结算，收益实时可见</p>
          </div>
          <div className="bg-slate-800 p-6 rounded-xl">
            <Lock className="w-12 h-12 text-blue-400 mb-4" />
            <h3 className="text-xl font-bold text-white mb-2">风控管理</h3>
            <p className="text-gray-400">专业风控团队，全程监控风险，确保资金安全</p>
          </div>
        </div>
      </div>
    </div>
